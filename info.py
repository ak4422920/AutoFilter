...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294594986 -1001769437975 -1001855645227').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002431609970'))  # Log channel id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.ibb.co/dwZK15q3/photo-2025-08-06-15-56-13-7535502004659945488.jpg')
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/how_to_open_link_ak')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/how_to_open_link_ak')  # Tutorial video link for opening shortlink website
...
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/zoroversex')
OWNERID = int(os.environ.get('OWNERID', '8371607189'))  # Replace with the actual admin ID
